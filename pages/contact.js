...
const Contact = () => {
  ...
  const handleOnSubmit = async (e) => {
	...
	const SEO = {
		...
		description: "If you're a busy couple planning your wedding and you think you may need help, please contact us.",
		openGraph: {
			type: "website",
			locale: "en_US",
		...
		<>
			...
			<Main className='container'>
				<div className="content">
					...
					<p>Call <a itemProp="telephone" href="tel:240-665-3350">(240) 665-3350</a></p>
					<p>Email <a href="mailto:monica@monicabrowneweddings.com" itemProp="email">monica@monicabrowneweddings.com</a></p>
					...
					<img src='../WebP-images/bride-with-flowers.webp' alt="Bride with flowers" />
						<Form onSubmit={handleOnSubmit}>
							...
							/>
							<SendButton type="submit" disabled={status.submitting || isEnabled}>
								{!status.submitting
									? !status.submitted
										? 'Send to Monica'
										: 'Submitted'
						...
						{!status.info.error && status.info.msg && (
							<div className="success">Your message has been sent to Monica</div>
						)}
					</ContactForm>
				</div>
			</Main>
