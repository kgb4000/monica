...
export default function Potomac() {
  ...
  const SEO = {
    title: 'Davidsonville Wedding Planner | Monica Browne Weddings',
    description:
      'Looking for a wedding planner in Davidsonville because you need some help? Call Monica Browne Weddings. We can help you plan the wedding of your dreams.',
    canonical: 'https://monicabrowneweddings.com/davidsonville',
    openGraph: {
      type: 'website',
      locale: 'en_US',
      url: 'https://monicabrowneweddings.com/davidsonville',
  ...
  return (
    <div>
      <NextSeo {...SEO} />
      <HeroSection
        heroText="Wedding Planning For Couples in Davidsonville"
        subText="We Create Beautiful Weddings For Busy Couples in Davidsonville Maryland"
      ...
      <Main>
        <section className="container">
          <div className="content">
            <h1 className="title">Davidsonville Wedding Planner</h1>
            <p className="intro">
        ...
        <section className="container">
          <div className="service-content">
            <h2 className="title">
              We Make Planning Your Wedding For Davidsonville Couples Simple
            </h2>
            <div>
              <Simple>
                <li>
