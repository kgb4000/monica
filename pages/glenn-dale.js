...
export default function Rockville() {
  ...
  const SEO = {
    title: 'Glenn Dale Wedding Planner | Monica Browne Weddings',
    description:
      'Looking for a wedding planner in Glenn Dale because you need some help? Call Monica Browne Weddings. We can help you plan the wedding of your dreams.',
    canonical: 'https://monicabrowneweddings.com/glenn-dale',
    openGraph: {
      type: 'website',
      locale: 'en_US',
      url: 'https://monicabrowneweddings.com/glenn-dale',
  ...
  return (
    <div>
      <NextSeo {...SEO} />
      <HeroSection
        heroText="Wedding Planning For Couples in Glenn Dale"
        subText="We Create Beautiful Weddings For Busy Couples in Glenn Dale Maryland"
      ...
      <Main>
        <section className="container">
          <div className="content">
            <h1 className="title">Glenn Dale Wedding Planner </h1>
            <p className="intro">
        ...
        <section className="container">
          <div className="service-content">
            <h2 className="title">
              We Make Wedding Planning For Glenn Dale Couples Easy
            </h2>
            <div>
              <Simple>
                <li>
