...
export default function Home() {
  ...
  const SEO = {
    title: 'Severna Park Wedding Planner | Monica Browne Weddings',
    description:
      'Looking for a wedding planner in Severna Park because you need some help? Call Monica Browne Weddings. We can help you plan the wedding of your dreams.',
    canonical: 'https://monicabrowneweddings.com/severan-park',
    openGraph: {
      type: 'website',
      locale: 'en_US',
      url: 'https://monicabrowneweddings.com/severan-park',
  ...
  return (
    <div>
      ...
      />
      <HeroSection
        heroText="Wedding Planning For Severna Park Couples"
        subText="We Create Beautiful Weddings For Busy Couples in Severna Park"
      ...
      <Main>
        <section className="container">
          <div className="content">
            <h1 className="title">Severna Park Wedding Planner</h1>
            <p className="intro">
              Even though you may not know where to start, a Severna Park
              wedding planner can help you have the wedding you always wanted.
              Monica Browne Weddings is here to help and guide you through the
              process. With our help and guidance, you will undoubtedly get the
              wedding you want and have time to do the other essential things in
              your life. We work with couples in Serverna Park, and throughout
              the Maryland, and are happy to bring your vision to life.
            </p>
        ...
        <section className="container">
          <div className="service-content">
            <h2 className="title">
              We Make Wedding Planning for Severna Park Couples Much Easy
            </h2>
            <div>
              <Simple>
                <li>
