...
export default function Home() {
  ...
  const SEO = {
    ...
    description:
      'Looking for a wedding planner in Silver Spring because you need some help? Call Monica Browne Weddings. We can help you plan the wedding of your dreams.',
      ...
      <Main>
        <section className="container">
          <div className="content">
            <h1 className="title">Wedding Planner in Silver Spring Maryland</h1>
            <p className="intro">
        ...
        <section className="container">
          <div className="service-content">
            <h2 className="title">
              We Make Planning Your Wedding in Silver Spring Less Stressful
            </h2>
            <div>
              <Simple>
                <li>
