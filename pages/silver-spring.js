...
export default function Home() {
  ...
  const SEO = {
		...
		description: "Are you a couple from Silver Spring planning your wedding? Let us help. We can help couples in Silver Spring plan the wedding of your dreams",
		openGraph: {
			type: "website",
			locale: "en_US",
      ...
      <Main>
        <section className='container'>
          <div className="content">
            <h1 className='title'>Wedding Planner in Silver Spring </h1>
          ...
          <div className="service-content">
            <div className="painpoints">
              <div className="painpoints--content">
                <h2 className='title'>Planning Your Wedding Can Be A Bear</h2>
                <PainPoints>
                  <li>Not knowing what you want and where to start</li>
                  <li>Information overload from corporate wedding websites and blogs</li>
