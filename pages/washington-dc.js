...
export default function Home() {
  ...
  const SEO = {
		title: "Washington DC Wedding Planner | Monica Browne Weddings",
		description: "Planning a wedding in Washington DC and don't know where to start? Let us help. We can help DC couples plan the wedding of your dreams",
		openGraph: {
			type: "website",
			locale: "en_US",
      ...
      <Main>
        <section className='container'>
          <div className="content">
            ...
            <p className="intro">Even though you may not know where to start planning your wedding, you can still have the wedding of your dreams. Monica Browne Weddings is here to help and guide you through the process. With our help and guidance, you will undoubtedly get the wedding you want and have time to do the other essential things in your life.</p>
          ...
          <div className="service-content">
            <div className="painpoints">
              <div className="painpoints--content">
                <h2 className='title'>Planning A Wedding Can Be An Smothering</h2>
                <PainPoints>
                  <li>Not knowing what you want and where to start planning</li>
                  <li>Information overload from big wedding websites and blogs</li>
                  <li>Having to trust vendors that you don't know with the most important day of your life</li>
                  <li>Setting up a timeline, guest lodging, ans seating charts</li>
        ...
        <section className='container'>
          <div className="content">
            ...
            <Testimonial>
              It has been 5 years and I still have family and friends tell me how beautiful my wedding day was. I could not have been more pleased at their work. They listened to all my wants and carried them out exactly how I asked them to. They were nice, understanding and very easy to work with. They kept me on track and made the experience enjoyable.
              </Testimonial>
