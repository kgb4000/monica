...
function Bowie({ data }) {
  ...
  const SEO = {
    title:
      'Wedding Planner in Bowie MD | Flowers, Design, Decorations and More',
    description:
      'Monica Browne is a full-service wedding planner and day-of coordinator for couples in Bowie Maryland. Contact us today to plan your dream wedding!',
  ...
  return (
    <div>
      <NextSeo {...SEO} />
      <HeroSection
        heroText="Wedding Planning for Bowie Couples"
        subText="We create beautiful intimate weddings for couples in Bowie, MD"
        backgroundImage="/images/bride-groom-outside.webp"
      ...
      <Main>
        <section className="container">
          <div className="content">
            ...
            <p>
              Monica Browne Weddings is here to help couples in Bowie through
        ...
        <PainSection
          ...
          alt="Flowers designed by Bowie wedding planner Monica Browne."
          width="472"
          height="708"
          pain1="Time looking on a wedding planner you can trust."
          pain2="Time finding the right caterer."
          ...
          pain6="Figuring out your budget and reading vendor contracts."
        />
        <section className="container">
          <div>
            <h2 className="title">Our Bowie Wedding Planning Services</h2>
            <Services>
        ...
        <section className="container">
          <div className="service-content get-started">
            <h2 className="title">
              We Make Wedding Planning For Bowie Couples Easy Pezy
            </h2>
            <div>
              <Simple>
                <li>
